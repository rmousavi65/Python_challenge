...
myfile="/Users/ranamousavi/Documents/GitHub/Python_challenge/Pypoll/Resources/election_data.csv"
...
resultfile="/Users/ranamousavi/Documents/GitHub/Python_challenge/Pypoll/Analysis/results.txt"
with open(resultfile, "w") as resultfile:

    resultfile.write("Election Results\n")
    resultfile.write("-------------------------\n")
    resultfile.write(f"Total Votes:  {sum(count_candidate.values())}\n")
    resultfile.write("-------------------------\n")
    resultfile.write(f"{votes_per_candidate[0][0][0]}: {first}% ({votes_per_candidate[0][0][1]})\n")
    resultfile.write(f"{votes_per_candidate[0][1][0]}: {second}% ({votes_per_candidate[0][1][1]})\n")
    resultfile.write(f"{votes_per_candidate[0][2][0]}: {third}% ({votes_per_candidate[0][2][1]})\n")
    resultfile.write("-------------------------\n")
    resultfile.write(f"Winner:  {votes_per_candidate[0][0][0]}\n")
    resultfile.write("-------------------------\n")    